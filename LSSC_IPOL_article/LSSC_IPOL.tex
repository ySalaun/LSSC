...
\begin{algorithm}[H]
\textbf{Input} : noisy picture $\noi$, pre-learned dictionary $\dict$ {\color{red} Marc: dire ce qu'est N}\\
...
TODO: se renseigner sur la  methode ? pk si A(j,j) = 0 ... \\
...
TODO: préciser la version + pk inversion bizarre des matrices
\\
...
Initialize patch norm and check if there is no trivial solution:\\
\vspace{0.5mm}
